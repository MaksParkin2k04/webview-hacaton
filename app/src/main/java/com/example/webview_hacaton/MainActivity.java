...
public class MainActivity extends AppCompatActivity {
    ...
    private void setInitialData() {
        ...
        states.add(new State("Я краснею", "Уверенная в себе тринадцатилетняя Мэй Ли разрывается между тем,\n" +
                ...
                " \t\t\tкогда она слишком волнуется (что с подростком случается практически всегда), она моментально превращается в гигантскую красную панду!","2022-03-10", R.drawable.picture_1,2));
        states.add(new State("Человек-паук: Нет пути домой", "Мистерио удаётся выяснить истинную личность Человека-паука.\n" +
                ...
                " Питер Паркер надеется, что с помощью магии он сможет восстановить его анонимность. Стрэндж соглашается помочь.","2021-12-15", R.drawable.picture_2, 3));
        states.add(new State("Проект «Адам»", "12-летний Адам Рид все еще скорбит по своему отцу, который умер год назад.\n" +
                ...
                " Герои должны объединить усилия, чтобы выполнить непростую миссию и спасти свой мир.","2022-03-11", R.drawable.picture_3,4));
        states.add(new State("Игра теней", "Трэвис Блок - правительственный агент, который пытается смириться со своим темным прошлым.\n" +
                " Когда он обнаруживает заговор, нацеленный на граждан США, Блок оказывается под прицелом директора ФБР, которого он когда-то помогал защищать.","2022-02-10", R.drawable.picture_4,5));
        states.add(new State("Энканто", "Удивительная семья Мадригалов живет в спрятанном в горах Колумбии волшебном доме, расположенном в чудесном и очаровательном уголке под названием Энканто.\n" +
                ...
                " Обнаружив, что магия Энканто находится в опасности, Мирабель решает, что именно она может быть последней надеждой на спасение своей особенной семьи.","2021-11-24", R.drawable.picture_5,1));
    }
}
