...
public class MainActivity extends AppCompatActivity {
        ...
        AdapterView.OnItemClickListener itemListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
             ...
             /*   TextView nameView = findViewById(R.id.name);
                TextView capitalView = findViewById(R.id.description);*/


               /* String name = nameView.getText().toString();
                String company = capitalView.getText().toString();*/
    ...
    private void setInitialData() {
        ...
        states.add(new State("Я краснею", "Уверенная в себе тринадцатилетняя Мэй Ли разрывается между тем,\n" +
                ...
                " \t\t\tкогда она слишком волнуется (что с подростком случается практически всегда), она моментально превращается в гигантскую красную панду!", R.drawable.picture_1));
        states.add(new State("Человек-паук: Нет пути домой", "Мистерио удаётся выяснить истинную личность Человека-паука.\n" +
                ...
                " Питер Паркер надеется, что с помощью магии он сможет восстановить его анонимность. Стрэндж соглашается помочь.", R.drawable.picture_2));
        states.add(new State("Проект «Адам»", "12-летний Адам Рид все еще скорбит по своему отцу, который умер год назад.\n" +
                ...
                " Герои должны объединить усилия, чтобы выполнить непростую миссию и спасти свой мир.", R.drawable.picture_3));
        states.add(new State("Игра теней", "Трэвис Блок - правительственный агент, который пытается смириться со своим темным прошлым.\n" +
                " Когда он обнаруживает заговор, нацеленный на граждан США, Блок оказывается под прицелом директора ФБР, которого он когда-то помогал защищать.", R.drawable.picture_4));
        states.add(new State("Энканто", "Удивительная семья Мадригалов живет в спрятанном в горах Колумбии волшебном доме, расположенном в чудесном и очаровательном уголке под названием Энканто.\n" +
                ...
                " Обнаружив, что магия Энканто находится в опасности, Мирабель решает, что именно она может быть последней надеждой на спасение своей особенной семьи.", R.drawable.picture_5));
    }
}
